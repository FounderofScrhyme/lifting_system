...
interface AssignmentCalendarDateCellProps {
...
export const AssignmentCalendarDateCell = memo(
  function AssignmentCalendarDateCell({
    children,
    value,
    siteCount = 0,
    isSelected = false,
  }: AssignmentCalendarDateCellProps) {
    return (
      <div
